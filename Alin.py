...
import time, random, sys, re, os, json, subprocess, threading, string, codecs, requests, tweepy, ctypes, urllib, urllib2, urllib3
...
||��✒ 1-4/pro        - [1pro: Namabot] Change Nama Bot
||��✒ S1-4glist      - [S1glist] Melihat Grup BOT
||��✒ Allbio:        - Change All Bio BOT
||��✒ Bot sp         - Tes Speed BOT
||��✒ Clear grup 	  - Bot Keluar Dari Semua Grup
||��✒ Remove chat 	  - Membersihkan History Chat Bot
||===== F O R  Y O U =====||
||��✒ Me
||��✒ Mymid
||��✒ Mid @          - Get MID 
||��✒ Block @
||��✒ Blocklist
||��✒ Clear chat 	  - Membersihkan History Chat
||��✒ Bc:ct 		  - [Bc:ct Teks] Broadcast Contact
||��✒ Bc:grup 		  - [Bc:grup Teks] Broadcast Grup
...
Bots = [mid,"u82059de6a56f0261975f860a1ef7361e"]
admsa = "u82059de6a56f0261975f860a1ef7361e"
admin = "u82059de6a56f0261975f860a1ef7361e"
...
def bot(op):
    try:
        ...
        if op.type == 26:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u82059de6a56f0261975f860a1ef7361e":
                    if "join:" in msg.text:
